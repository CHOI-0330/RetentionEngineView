...
interface QuestionCardChatPanelProps {
  onClose: () => void;
...
export const QuestionCardChatPanel = memo(function QuestionCardChatPanel({
  onClose,
  originalAiMessage,
  accessToken,
  sourceConvId,
  sourceMsgId,
}: QuestionCardChatPanelProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      <PanelHeader onClose={handleClose} subtitle="AIがあなたの質問を整理するお手伝いをします" />
  ...
  return (
    <div className="flex items-center justify-between border-b px-4 py-3 shrink-0">
      <div className="min-w-0">
        <h2 className="text-sm font-semibold truncate">質問カードを作成</h2>
        {subtitle && (
